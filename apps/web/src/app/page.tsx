    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-950 dark:bg-black dark:text-zinc-50">
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-6 py-20">
        <header className="flex flex-col gap-3">
          <p className="text-sm font-medium uppercase tracking-wide text-zinc-500">Playdate</p>
          <h1 className="text-4xl font-semibold tracking-tight">Say “We&apos;re available” in one tap.</h1>
          <p className="max-w-prose text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            Coordinate playdates with connected families fast: broadcast availability first, then handle invites,
        ...
        <footer className="pt-6 text-sm text-zinc-500 dark:text-zinc-500">
          <p>
            This is an early preview. If you&apos;re seeing the Next.js starter page, something is misconfigured.
          </p>
        </footer>
      </main>
    </div>
